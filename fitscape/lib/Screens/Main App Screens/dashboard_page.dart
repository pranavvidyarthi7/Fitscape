                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'last update 3m',
                              style: robotoB16.copyWith(
                                  color: Color(0xffEAEAEA), fontSize: 12.0),
                            ),
                          ],
                        ),
                      )),
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: LiquidCustomProgressIndicator(
                                  ...
                                  valueColor:
                                      AlwaysStoppedAnimation(Color(0xff42C9FF)),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'last update 3m',
                                style: robotoB16.copyWith(
                                    color: Color(0xffA2A8BF), fontSize: 12.0),
                              ),
                            ],
                          ),
                        )),
