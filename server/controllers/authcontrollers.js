    ...
    //Route for google authentication of user
    module.exports.gauth = async (req, res) => {
      console.log('google authentication route');
      ...
      else
      {
              try{
                ...
                const {name,email,password,avatar,gender,phone } = req.body;
